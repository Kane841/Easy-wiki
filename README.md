...
> 完整进度与验收清单见 [`docs/superpowers/progress/2026-07-07-easy-wiki-v1-progress.md`](docs/superpowers/progress/2026-07-07-easy-wiki-v1-progress.md)（在 `feature/easy-wiki-v1` 分支）。

### 获取最新代码

`main` 分支目前为项目初始化脚手架；**V1.0 完整实现请切换到开发分支：**

```bash
git fetch origin
git checkout feature/easy-wiki-v1
```
...
更多 curl 用例见 [`docs/E2E-CHECKLIST.md`](docs/E2E-CHECKLIST.md)（`feature/easy-wiki-v1` 分支）。
...
- **分支**：V1.0 完整代码在 `feature/easy-wiki-v1`，合并 `main` 前请确认已切换分支
